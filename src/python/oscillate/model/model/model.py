...
class TTAModel(nn.Module):
	...
	def __init__(self, encoder: Encoder, decoder: Decoder, *args, decoder_vocab_size=1024, **kwargs):
		super().__init__(*args, **kwargs)
		self.encoder = encoder
		self.decoder = decoder
		self.enc_reshape = nn.Linear(self.encoder.emb_size, self.decoder.emb_size)
		self.dec_reshape = nn.Linear(self.decoder.emb_size, decoder_vocab_size*self.decoder.emb_size)
